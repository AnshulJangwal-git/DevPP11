...
(async function login(){
    try{
        ...
        for(let i = 0; i < challenges.length; i++){
            await addChallenges(createChallengeLink, browser, challenges[i]) ;
...
async function addChallenges(createChallengeLink, browser, challenge){
    try{
    ...
    //   }
        ...
        await newTab.waitForSelector(3000) ;
        await newTab.close() ;
